...
interface CirclesSDKContextType {
  ...
  circlesProvider: any; // Replace 'any' with the actual type if known
...
export const CirclesSDK: React.FC<CirclesSDKProps> = ({ children }) => {
  ...
  const [circlesProvider, setCirclesProvider] = useState<any>(null); // Replace 'any' with the actual type if known
